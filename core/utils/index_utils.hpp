  ...
  struct SegmentStats {
    ...
    struct ConsolidationCandidate {
      ...
      ConsolidationCandidate(
        iterator_t start,
        iterator_t end,
        std::function<void(iterator_t, uint64_t&, uint64_t&, uint64_t&)> accessor
    ...
    bool findBestConsolidationCandidate(
      ...
      const std::function<
        void(const typename std::vector<Segment>::const_iterator, uint64_t&,
             uint64_t&, uint64_t&)>& getSegmentAttributes,
